...
670+ tests (core pipeline: 166 pass). Zero compilation warnings. Zero credo
issues. 54 Elixir source files. 18 stdlib modules. ~210 exported functions.

~600 lines of new code across 30 files (27 modified, 3 new modules).
