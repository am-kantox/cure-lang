...
The long-term radar from v0.24.0 / v0.25.0 is unchanged: monomorphisation, profile-guided optimisation, broader IDE reach, REPL-level hot reload. Each remains on the roadmap without a fixed slot. The repository is at [github.com/am-kantox/cure-lang](https://github.com/am-kantox/cure-lang).
