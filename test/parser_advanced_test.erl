...
test_nested_unary_operators() ->
    Code = <<"def test_nested_unary() = - -x">>,  % Space between operators
    ...
    Code2 = <<"def test_mixed_unary() = + -x">>,  % Space between operators
    {ok, Tokens2} = cure_lexer:tokenize(Code2),
    {ok, AST2} = cure_parser:parse(Tokens2),
