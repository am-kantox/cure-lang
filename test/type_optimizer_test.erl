...
test_type_information_collection() ->
    ...
    io:format(
        " [Functions: ~w, CallSites: ~w, Types: ~w] ",
...
test_function_call_analysis() ->
    ...
    maps:fold(
        fun(_FuncName, SiteList, _) ->
            lists:foreach(
                fun({Location, ArgTypes}) ->
...
test_specialization_candidates() ->
    ...
    maps:fold(
        fun(_FuncName, Candidates, _) ->
            true = is_list(Candidates),
            lists:foreach(
                fun({Pattern, {Cost, Benefit}}) ->
        ...
        #function_def{
            ...
            params = [
                ...
                #param{
                    name = y,
                    type = {primitive_type, 'Int'},
                    location = #location{line = 1, column = 3, file = "test"}
                }
            ],
            ...
            body = #binary_op_expr{
                ...
                right = #identifier_expr{
                    name = y, location = #location{line = 2, column = 3, file = "test"}
                },
        ...
        #function_def{
            ...
            params = [
                ...
                #param{
                    name = b,
                    type = {primitive_type, 'Float'},
                    location = #location{line = 4, column = 3, file = "test"}
                }
            ],
            ...
            body = #binary_op_expr{
                op = '*',
                left = #identifier_expr{
                    name = a, location = #location{line = 5, column = 1, file = "test"}
                },
                right = #identifier_expr{
                    name = b, location = #location{line = 5, column = 3, file = "test"}
                },
    ...
    [
        #function_def{
            ...
            body = #function_call_expr{
                function = #identifier_expr{
                    name = add, location = #location{line = 2, column = 1, file = "test"}
                },
                args = [
                    #literal_expr{
        ...
        #function_def{
            ...
            body = #binary_op_expr{
                op = '+',
                left = #identifier_expr{
                    name = x, location = #location{line = 5, column = 1, file = "test"}
                },
                right = #identifier_expr{
                    name = y, location = #location{line = 5, column = 3, file = "test"}
                },
                location = #location{line = 5, column = 2, file = "test"}
            },
            location = #location{line = 4, column = 1, file = "test"}
        ...
        #function_def{
            ...
            params = [
                ...
                #param{
                    ...
                    location = #location{line = 1, column = 5, file = "test"}
                }
            ],
...
create_sample_ast_with_many_calls() ->
    ...
    CallExprs = [
        #function_call_expr{
            function = #identifier_expr{
                name = helper, location = #location{line = 2, column = I, file = "test"}
            },
            args = [
                #literal_expr{
    ...
    [
        #function_def{
            ...
            constraint = undefined,
            body = #block_expr{
                expressions = CallExprs, location = #location{line = 2, column = 1, file = "test"}
            },
            location = #location{line = 1, column = 1, file = "test"}
        },
        #function_def{
...
create_sample_ast_with_polymorphic_calls() ->
    ...
    [
        ...
        #function_def{
            ...
            constraint = undefined,
            body = #identifier_expr{
                name = x, location = #location{line = 11, column = 1, file = "test"}
            },
...
test_inlining_optimization() ->
    ...
    EnhancedUsageStats = UsageStats#usage_statistics{
        ...
        hot_paths = [[small_add], [tiny_helper]]
    },
        ...
        #function_def{
            ...
            params = [
                ...
                #param{
                    name = b,
                    type = {primitive_type, 'Int'},
                    location = #location{line = 7, column = 3, file = "test"}
                },
                #param{
                    name = c,
                    type = {primitive_type, 'Int'},
                    location = #location{line = 7, column = 5, file = "test"}
                }
            ],
            return_type = {primitive_type, 'Int'},
            constraint = undefined,
            body = #block_expr{
                expressions = [
                    #binary_op_expr{
                        op = '+',
                        left = #identifier_expr{
                            name = a, location = #location{line = 8, column = 1, file = "test"}
                        },
                        right = #identifier_expr{
                            name = b, location = #location{line = 8, column = 3, file = "test"}
                        },
                    ...
                    #binary_op_expr{
                        op = '-',
                        left = #identifier_expr{
                            name = a, location = #location{line = 10, column = 1, file = "test"}
                        },
                        right = #identifier_expr{
                            name = c, location = #location{line = 10, column = 3, file = "test"}
                        },
...
test_dead_code_elimination_with_types() ->
    ...
    EnhancedUsageStats = UsageStats#usage_statistics{
        % Mark functions as unused
        cold_code = [unused_helper, dead_function]
    },
