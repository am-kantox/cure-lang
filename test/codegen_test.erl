...
test_basic_expression_compilation() ->
    ...
    LiteralExpr = #literal_expr{value = 42, location = #location{line = 1, column = 1, file = "test"}},
    ...
    ?assertEqual(3, length(BinaryInstructions)),  % load_literal, load_literal, binary_op
...
test_function_compilation() ->
    ...
    Function = #function_def{
        name = add,
        params = [
            #param{name = x, type = undefined, location = #location{line = 1, column = 1, file = "test"}},
            #param{name = y, type = undefined, location = #location{line = 1, column = 1, file = "test"}}
        ],
        return_type = undefined,
        constraint = undefined,
        body = #binary_op_expr{
            op = '+',
            left = #identifier_expr{name = x, location = #location{line = 1, column = 1, file = "test"}},
            right = #identifier_expr{name = y, location = #location{line = 1, column = 1, file = "test"}},
            location = #location{line = 1, column = 1, file = "test"}
        },
        location = #location{line = 1, column = 1, file = "test"}
    },
...
test_module_compilation() ->
    ...
    Module = #module_def{
        name = test_module,
        exports = [
            #export_spec{name = double, arity = 1, location = #location{line = 1, column = 1, file = "test"}}
        ],
        items = [
            #function_def{
                name = double,
...
test_beam_file_generation() ->
    ...
    case cure_codegen:convert_to_erlang_forms(SimpleModule) of
        {ok, Forms} ->
            ...
            ?assert(length(Forms) >= 2),  % At least module and export attributes
...
test_instruction_optimization() ->
    ...
    Instructions = [
        ...
        #beam_instr{op = load_literal, args = [42], location = undefined},  % Duplicate
