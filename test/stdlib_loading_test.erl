    ...
    SampleAST = [
        {module_def, 'TestModule', [], [
            ...
            {function_def, add, [
             ...
             {binary_op_expr, '+', 
              {identifier_expr, x, undefined}, 
              {identifier_expr, y, undefined}, undefined}, false, undefined},
            ...
            {function_def, multiply, [
             ...
             {binary_op_expr, '*',
              {identifier_expr, a, undefined},
              {identifier_expr, b, undefined}, undefined}, false, undefined},
            
            % Private function (should not be extracted)
            {function_def, helper, [
                {param, x, {primitive_type, 'Int'}, undefined}
            ], {primitive_type, 'Int'}, undefined,
             {identifier_expr, x, undefined}, true, undefined}
        ], undefined}
    ],
...
test_get_stdlib_function_type() ->
    ...
    % Std.Core functions
    ?assertMatch({ok, {function_type, _, _}}, 
                 cure_typechecker:get_stdlib_function_type('Std.Core', identity, 1)),
    
    ?assertMatch({ok, {function_type, [_, _], _}}, 
...
test_create_function_type_from_signature() ->
    ...
    Params4 = [
        ...
        {param, func, {function_type, [{primitive_type, 'Int'}], {primitive_type, 'String'}}, undefined}
    ],
...
test_create_function_type_from_signature_records() ->
    ...
    Params4 = [
        {param, x, {primitive_type, 'Int'}, undefined},  % Tuple format
        #param{name = y, type = {primitive_type, 'String'}, location = undefined}  % Record format
    ],
