...
test_boolean_logic_guards() ->
    ...
    LoadInstructions = [
        I
     || I <- Instructions, I#beam_instr.op =:= load_param orelse I#beam_instr.op =:= load_literal
    ],
...
test_fsm_guard_compilation() ->
    ...
    % Compile guard
    State = #codegen_state{local_vars = #{}},
    {ok, GuardInstructions, _} = cure_guard_compiler:compile_guard(
        Transition#transition.guard, State
    ),
